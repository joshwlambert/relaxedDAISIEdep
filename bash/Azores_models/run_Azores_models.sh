...
#SBATCH --output=/data/p287218/relaxedDAISIE/logs/Azores/Azores_models%a.log
#SBATCH --array=0-8
#SBATCH --mem=1GB
...
sbatch /data/p287218/relaxedDAISIE/bash/Azores_models/run_Azores_${models[SLURM_ARRAY_TASK_ID]}.sh
