...
#SBATCH --output=/home/p287218/relaxedDAISIE/logs/Guadalupe%a.log
#SBATCH --array=0-8
#SBATCH --mem=5GB
...
Rscript /home/p287218/relaxedDAISIE/scripts/Guadalupe_models/Guadalupe_${models[SLURM_ARRAY_TASK_ID]}.R
