...
#SBATCH --output=/data/p287218/relaxedDAISIE/logs/Guam_Marianas/Guam_Marianas_models%a.log
#SBATCH --array=0-8
#SBATCH --mem=1GB
...
sbatch /data/p287218/relaxedDAISIE/bash/Guam_Marianas_models/run_Guam_Marianas_${models[SLURM_ARRAY_TASK_ID]}.sh
