...
sbatch --job-name=ml_Marquesas DAISIEutils/bash/submit_run_daisie_ml_long.sh Marquesas cr_di relaxedDAISIE 5
...
sbatch --job-name=ml_Marquesas DAISIEutils/bash/submit_run_daisie_ml_long.sh Marquesas rr_lac_di relaxedDAISIE 5
...
sbatch --job-name=ml_Marquesas DAISIEutils/bash/submit_run_daisie_ml_long.sh Marquesas rr_mu_di relaxedDAISIE 5
...
sbatch --job-name=ml_Marquesas DAISIEutils/bash/submit_run_daisie_ml_long.sh Marquesas rr_laa_di relaxedDAISIE 5
