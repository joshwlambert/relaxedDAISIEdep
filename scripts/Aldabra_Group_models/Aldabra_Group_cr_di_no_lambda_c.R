# Aldabra Group constant rate diversity-independent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Aldabra_Group",
                               "Aldabra_Group_cr_di_no_lambda_c.RData")
Aldabra_Group_cr_di_no_lambda_c_results <- list(
  Aldabra_Group_cr_di_no_lambda_c_max_loglik = Aldabra_Group_cr_di_no_lambda_c_max_loglik,
  Aldabra_Group_cr_di_no_lambda_c_BIC = Aldabra_Group_cr_di_no_lambda_c_BIC)

save(Aldabra_Group_cr_di_no_lambda_c_results,
