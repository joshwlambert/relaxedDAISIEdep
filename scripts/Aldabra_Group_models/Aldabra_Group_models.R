...
for (i in seq_along(init_param_set)) {
  Aldabra_Group_rr_mu_di_no_lambda_c[[i]] <- DAISIE_ML_CS(
    datalist = Aldabra_Group,
    initparsopt = c(Aldabra_Group_rr_mu_di_no_lambda_c_init[[i]]$mu,
...
max_loglik <- which(max(loglik) == loglik)
Aldabra_Group_rr_mu_di_no_lambda_c_max_loglik <-
  Aldabra_Group_rr_mu_di_no_lambda_c[[max_loglik]]

#Calculate BIC
Aldabra_Group_rr_mu_di_no_lambda_c_BIC <-
  4 * (log(1000) + log(2 * pi)) -
...
for (i in seq_along(init_param_set)) {
  Aldabra_Group_rr_mu_dd_no_lambda_c_init[[i]] <- DAISIE_ML_CS(
    datalist = Aldabra_Group,
    initparsopt = c(init_param_set[[i]][2],
                    init_param_set[[i]][3],
                    init_param_set[[i]][4],
...
Aldabra_Group_rr_mu_dd_no_lambda_c <- list()

for (i in seq_along(init_param_set)) {
  Aldabra_Group_rr_mu_dd_no_lambda_c[[i]] <- DAISIE_ML_CS(
    datalist = Aldabra_Group,
...
#Extract global optima
loglik <- sapply(Aldabra_Group_rr_mu_dd_no_lambda_c, '[[', 6)
max_loglik <- which(max(loglik) == loglik)
Aldabra_Group_rr_mu_dd_no_lambda_c_max_loglik <-
  Aldabra_Group_rr_mu_dd_no_lambda_c[[max_loglik]]

#Calculate BIC
Aldabra_Group_rr_mu_dd_no_lambda_c_BIC <-
  5 * (log(1000) + log(2 * pi)) -
...
for (i in seq_along(init_param_set)) {
  Aldabra_Group_rr_k_no_lambda_c_init[[i]] <- DAISIE_ML_CS(
    datalist = Aldabra_Group,
    initparsopt = c(init_param_set[[i]][2],
                    init_param_set[[i]][3],
                    init_param_set[[i]][4],
...
Aldabra_Group_rr_k_no_lambda_c <- list()
...
#Extract global optima
loglik <- sapply(Aldabra_Group_rr_k_no_lambda_c, '[[', 6)
max_loglik <- which(max(loglik) == loglik)
Aldabra_Group_rr_k_no_lambda_c_max_loglik <-
  Aldabra_Group_rr_k_no_lambda_c[[max_loglik]]

#Calculate BIC
Aldabra_Group_rr_k_no_lambda_c_BIC <-
  5 * (log(1000) + log(2 * pi)) -
