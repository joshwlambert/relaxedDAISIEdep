# Aldabra Group relaxed rate carrying capacity no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Aldabra_Group",
                               "Aldabra_Group_rr_k_no_lambda_c.RData")
Aldabra_Group_rr_k_no_lambda_c_results <- list(
...
save(Aldabra_Group_rr_k_no_lambda_c_results,
