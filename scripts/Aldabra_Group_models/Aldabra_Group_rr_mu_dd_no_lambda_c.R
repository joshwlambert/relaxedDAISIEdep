# Aldabra Group relaxed rate extinction diversity-dependent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Aldabra_Group",
                               "Aldabra_Group_rr_mu_dd_no_lambda_c.RData")
Aldabra_Group_rr_mu_dd_no_lambda_c_results <- list(
...
save(Aldabra_Group_rr_mu_dd_no_lambda_c_results,
