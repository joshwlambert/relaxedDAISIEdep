# Azores constant rate diversity-independent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Azores",
                               "Azores_cr_di_no_lambda_c.RData")
Azores_cr_di_no_lambda_c_results <- list(
  Azores_cr_di_no_lambda_c_max_loglik = Azores_cr_di_no_lambda_c_max_loglik,
  Azores_cr_di_no_lambda_c_BIC = Azores_cr_di_no_lambda_c_BIC)

save(Azores_cr_di_no_lambda_c_results,
