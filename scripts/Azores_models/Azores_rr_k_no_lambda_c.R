# Azores relaxed rate carrying capacity no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Azores",
                               "Azores_rr_k_no_lambda_c.RData")
Azores_rr_k_no_lambda_c_results <- list(
...
save(Azores_rr_k_no_lambda_c_results,
