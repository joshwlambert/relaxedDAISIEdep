# Azores relaxed rate anagenesis diversity-independent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Azores",
                               "Azores_rr_lambda_a_di_no_lambda_c.RData")
Azores_rr_lambda_a_di_no_lambda_c_results <- list(
...
save(Azores_rr_lambda_a_di_no_lambda_c_results,
