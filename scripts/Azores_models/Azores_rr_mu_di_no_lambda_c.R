# Azores relaxed rate extinction diversity-independent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Azores",
                               "Azores_rr_mu_di_no_lambda_c.RData")
Azores_rr_mu_di_no_lambda_c_results <- list(
...
save(Azores_rr_mu_di_no_lambda_c_results,
