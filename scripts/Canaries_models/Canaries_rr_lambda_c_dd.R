# Canaries relaxed rate cladogenesis diversity-dependent model
...
results_file_path <- file.path(getwd(), "results", "Canaries",
                               "Canaries_rr_lambda_c_dd.RData")
Canaries_rr_lambda_c_dd_results <- list(
  Canaries_rr_lambda_c_dd_max_loglik = Canaries_rr_lambda_c_dd_max_loglik,
  Canaries_rr_lambda_c_dd_BIC = Canaries_rr_lambda_c_dd_BIC)

save(Canaries_rr_lambda_c_dd_results,
