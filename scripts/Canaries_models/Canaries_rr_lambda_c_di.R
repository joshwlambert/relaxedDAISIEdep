# Canaries relaxed rate cladogenesis diversity-independent model
...
results_file_path <- file.path(getwd(), "results", "Canaries",
                               "Canaries_rr_lambda_c_di.RData")
Canaries_rr_lambda_c_di_results <- list(
  Canaries_rr_lambda_c_di_max_loglik = Canaries_rr_lambda_c_di_max_loglik,
  Canaries_rr_lambda_c_di_BIC = Canaries_rr_lambda_c_di_BIC)

save(Canaries_rr_lambda_c_di_results,
