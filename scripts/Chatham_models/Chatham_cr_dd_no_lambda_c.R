# Chatham constant rate diversity-dependent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Chatham",
                               "Chatham_cr_dd_no_lambda_c.RData")
Chatham_cr_dd_no_lambda_c_results <- list(
...
save(Chatham_cr_dd_no_lambda_c_results,
