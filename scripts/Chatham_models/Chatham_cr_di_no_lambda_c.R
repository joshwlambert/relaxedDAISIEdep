# Chatham constant rate diversity-independent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Chatham",
                               "Chatham_cr_di_no_lambda_c.RData")
Chatham_cr_di_no_lambda_c_results <- list(
  Chatham_cr_di_no_lambda_c_max_loglik = Chatham_cr_di_no_lambda_c_max_loglik,
  Chatham_cr_di_no_lambda_c_BIC = Chatham_cr_di_no_lambda_c_BIC)

save(Chatham_cr_di_no_lambda_c_results,
