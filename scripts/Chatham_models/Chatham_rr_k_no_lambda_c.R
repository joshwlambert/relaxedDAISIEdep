# Chatham relaxed rate carrying capacity no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Chatham",
                               "Chatham_rr_k_no_lambda_c.RData")
Chatham_rr_k_no_lambda_c_results <- list(
...
save(Chatham_rr_k_no_lambda_c_results,
