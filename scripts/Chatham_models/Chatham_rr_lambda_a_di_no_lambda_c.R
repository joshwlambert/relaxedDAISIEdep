# Chatham relaxed rate anagenesis diversity-independent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Chatham",
                               "Chatham_rr_lambda_a_di_no_lambda_c.RData")
Chatham_rr_lambda_a_di_no_lambda_c_results <- list(
...
save(Chatham_rr_lambda_a_di_no_lambda_c_results,
