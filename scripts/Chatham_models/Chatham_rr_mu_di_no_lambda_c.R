# Chatham relaxed rate extinction diversity-independent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Chatham",
                               "Chatham_rr_mu_di_no_lambda_c.RData")
Chatham_rr_mu_di_no_lambda_c_results <- list(
...
save(Chatham_rr_mu_di_no_lambda_c_results,
