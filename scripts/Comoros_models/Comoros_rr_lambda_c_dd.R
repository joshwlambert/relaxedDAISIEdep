# Comoros relaxed rate cladogenesis diversity-dependent model
...
results_file_path <- file.path(getwd(), "results", "Comoros",
                               "Comoros_rr_lambda_c_dd.RData")
Comoros_rr_lambda_c_dd_results <- list(
  Comoros_rr_lambda_c_dd_max_loglik = Comoros_rr_lambda_c_dd_max_loglik,
  Comoros_rr_lambda_c_dd_BIC = Comoros_rr_lambda_c_dd_BIC)

save(Comoros_rr_lambda_c_dd_results,
