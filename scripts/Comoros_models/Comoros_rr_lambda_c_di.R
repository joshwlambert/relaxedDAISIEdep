# Comoros relaxed rate cladogenesis diversity-independent model
...
results_file_path <- file.path(getwd(), "results", "Comoros",
                               "Comoros_rr_lambda_c_di.RData")
Comoros_rr_lambda_c_di_results <- list(
  Comoros_rr_lambda_c_di_max_loglik = Comoros_rr_lambda_c_di_max_loglik,
  Comoros_rr_lambda_c_di_BIC = Comoros_rr_lambda_c_di_BIC)

save(Comoros_rr_lambda_c_di_results,
