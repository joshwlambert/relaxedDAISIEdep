# Galapagos constant rate diversity-independent no anagenesis model
...
results_file_path <- file.path(getwd(), "results", "Galapagos",
                               "Galapagos_cr_di_no_lambda_a.RData")
Galapagos_cr_di_no_lambda_a_results <- list(
...
save(Galapagos_cr_di_no_lambda_a_results,
