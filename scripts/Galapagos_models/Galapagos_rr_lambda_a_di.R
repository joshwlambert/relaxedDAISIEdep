# Galapagos relaxed rate anagenesis diversity-independent model
...
results_file_path <- file.path(getwd(), "results", "Galapagos",
                               "Galapagos_rr_lambda_a_di.RData")
Galapagos_rr_lambda_a_di_results <- list(
...
save(Galapagos_rr_lambda_a_di_results,
