# Galapagos relaxed rate cladogenesis diversity-dependent model
...
results_file_path <- file.path(getwd(), "results", "Galapagos",
                               "Galapagos_rr_lambda_c_dd.RData")
Galapagos_rr_lambda_c_dd_results <- list(
  Galapagos_rr_lambda_c_dd_max_loglik = Galapagos_rr_lambda_c_dd_max_loglik,
  Galapagos_rr_lambda_c_dd_BIC = Galapagos_rr_lambda_c_dd_BIC)

save(Galapagos_rr_lambda_c_dd_results,
