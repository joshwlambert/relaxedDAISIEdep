# Galapagos relaxed rate cladogenesis diversity-independent model
...
results_file_path <- file.path(getwd(), "results", "Galapagos",
                               "Galapagos_rr_lambda_c_di.RData")
Galapagos_rr_lambda_c_di_results <- list(
  Galapagos_rr_lambda_c_di_max_loglik = Galapagos_rr_lambda_c_di_max_loglik,
  Galapagos_rr_lambda_c_di_BIC = Galapagos_rr_lambda_c_di_BIC)

save(Galapagos_rr_lambda_c_di_results,
