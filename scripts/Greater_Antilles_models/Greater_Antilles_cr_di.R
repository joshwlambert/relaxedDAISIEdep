# Greater Antilles constant rate diversity-independent model
...
Greater_Antilles_cr_di_max_loglik <- Greater_Antilles_cr_di[[max_loglik]]

#Calculate BIC
Greater_Antilles_cr_di_BIC <-
  4 * (log(100) + log(2 * pi)) - 2 * Greater_Antilles_cr_di[[max_loglik]]$loglik

#Save results
results_file_path <- file.path(getwd(), "results", "Greater_Antilles",
                               "Greater_Antilles_cr_di.RData")
Greater_Antilles_cr_di_results <- list(
  Greater_Antilles_cr_di_max_loglik = Greater_Antilles_cr_di_max_loglik,
  Greater_Antilles_cr_di_BIC = Greater_Antilles_cr_di_BIC)

save(Greater_Antilles_cr_di_results,
