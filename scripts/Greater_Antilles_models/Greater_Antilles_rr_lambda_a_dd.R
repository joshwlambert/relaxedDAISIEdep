# Greater Antilles relaxed rate anagenesis diversity-dependent model
...
results_file_path <- file.path(getwd(), "results", "Greater_Antilles",
                               "Greater_Antilles_rr_lambda_a_dd.RData")
Greater_Antilles_rr_lambda_a_dd_results <- list(
...
save(Greater_Antilles_rr_lambda_a_dd_results,
