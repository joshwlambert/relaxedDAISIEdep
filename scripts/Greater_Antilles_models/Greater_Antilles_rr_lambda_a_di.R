# Greater Antilles relaxed rate anagenesis diversity-independent model
...
results_file_path <- file.path(getwd(), "results", "Greater_Antilles",
                               "Greater_Antilles_rr_lambda_a_di.RData")
Greater_Antilles_rr_lambda_a_di_results <- list(
...
save(Greater_Antilles_rr_lambda_a_di_results,
