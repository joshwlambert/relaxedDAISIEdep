# Greater Antilles relaxed rate extinction diversity-dependent model
...
results_file_path <- file.path(getwd(), "results", "Greater_Antilles",
                               "Greater_Antilles_rr_mu_dd.RData")
Greater_Antilles_rr_mu_dd_results <- list(
...
save(Greater_Antilles_rr_mu_dd_results,
