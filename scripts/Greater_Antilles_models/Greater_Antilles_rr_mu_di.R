### Greater Antilles relaxed rate extinction diversity-independent model
...
results_file_path <- file.path(getwd(), "results", "Greater_Antilles",
                               "Greater_Antilles_rr_mu_di.RData")
Greater_Antilles_rr_mu_di_results <- list(
...
save(Greater_Antilles_rr_mu_di_results,
