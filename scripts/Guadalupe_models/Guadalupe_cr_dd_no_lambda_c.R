# Guadalupe constant rate diversity-dependent no cladogenesis model
...
Guadalupe_cr_dd_no_lambda_c_max_loglik <- Guadalupe_cr_dd_no_lambda_c[[max_loglik]]

#Calculate BIC
Guadalupe_cr_dd_no_lambda_c_BIC <-
  4 * (log(1000) + log(2 * pi)) -
  2 * Guadalupe_cr_dd_no_lambda_c[[max_loglik]]$loglik

#Save results
results_file_path <- file.path(getwd(), "results", "Guadaplupe",
                               "Guadalupe_cr_dd_no_lambda_c.RData")
Guadalupe_cr_dd_no_lambda_c_results <- list(
...
save(Guadalupe_cr_dd_no_lambda_c_results,
