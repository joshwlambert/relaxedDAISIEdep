# Guadalupe relaxed rate carrying capacity no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Guadaplupe",
                               "Guadalupe_rr_k_no_lambda_c.RData")
Guadalupe_rr_k_no_lambda_c_results <- list(
...
save(Guadalupe_rr_k_no_lambda_c_results,
