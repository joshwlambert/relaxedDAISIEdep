# Guadalupe relaxed rate anagenesis diversity-dependent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Guadaplupe",
                               "Guadalupe_rr_lambda_a_dd_no_lambda_c.RData")
Guadalupe_rr_lambda_a_dd_no_lambda_c_results <- list(
...
save(Guadalupe_rr_lambda_a_dd_no_lambda_c_results,
