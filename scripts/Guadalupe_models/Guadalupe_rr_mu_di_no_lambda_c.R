# Guadalupe relaxed rate extinction diversity-independent no cladogenesis model
...
results_file_path <- file.path(getwd(), "results", "Guadaplupe",
                               "Guadalupe_rr_mu_di_no_lambda_c.RData")
Guadalupe_rr_mu_di_no_lambda_c_results <- list(
...
save(Guadalupe_rr_mu_di_no_lambda_c_results,
