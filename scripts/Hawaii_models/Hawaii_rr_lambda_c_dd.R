# Hawaii relaxed rate cladogenesis diversity-dependent model
...
results_file_path <- file.path(getwd(), "results", "Hawaii",
                               "Hawaii_rr_lambda_c_dd.RData")
Hawaii_rr_lambda_c_dd_results <- list(
  Hawaii_rr_lambda_c_dd_max_loglik = Hawaii_rr_lambda_c_dd_max_loglik,
  Hawaii_rr_lambda_c_dd_BIC = Hawaii_rr_lambda_c_dd_BIC)

save(Hawaii_rr_lambda_c_dd_results,
