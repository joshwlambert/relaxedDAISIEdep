# Hispaniola constant rate diversity-dependent no anagenesis model
...
Hispaniola_cr_dd_no_lambda_a_max_loglik <- Hispaniola_cr_dd_no_lambda_a[[max_loglik]]

#Calculate BIC
Hispaniola_cr_dd_no_lambda_a_BIC <-
  4 * (log(300) + log(2 * pi)) -
  2 * Hispaniola_cr_dd_no_lambda_a[[max_loglik]]$loglik
