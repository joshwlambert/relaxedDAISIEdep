...
#Calculate BIC
BIC <- 4 * (log(1000) + log(2 * pi)) - 2 * Norfolk_cr_di[[max_loglik]]$loglik
...
#Calculate BIC
BIC <- 5 * (log(1000) + log(2 * pi)) - 2 * Norfolk_cr_dd[[max_loglik]]$loglik
...
#Calculate BIC
BIC <- 3 * (log(1000) + log(2 * pi)) - 2 * Norfolk_cr_di_no_lambda_c[[max_loglik]]$loglik
...
#Calculate BIC
BIC <- 4 * (log(1000) + log(2 * pi)) - 2 * Norfolk_cr_dd_no_lambda_c[[max_loglik]]$loglik
