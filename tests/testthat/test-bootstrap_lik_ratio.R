test_that("bootstrap_lik_ratio produces the correct output", {
  if (Sys.getenv("TRAVIS") != "" || Sys.getenv("APPVEYOR") != "") {
    ...
    expected_output <- list(lik_ratio_0 = 5,
                            ...
                            ml_1_model_1 = data.frame(lambda_c = 1.01579120031,
                                                      mu = 0.161189649777,
                                                      K = Inf,
                                                      ...
                                                      df = 5,
                                                      conv = 0),
                            ml_2_model_1 = data.frame(lambda_c = 1.07175370341,
                                                      mu = 0.675534112819,
                                                      K = Inf,
                                                      ...
                                                      df = 4,
                                                      conv = 0),
                            ml_1_model_2 = data.frame(lambda_c = 0.887088049795,
                                                      mu = 0.720075465905,
                                                      K = Inf,
                                                      ...
                                                      df = 5,
                                                      conv = 0),
                            ml_2_model_1 = data.frame(lambda_c = 0.887088077566,
                                                      mu = 0.720075720824,
                                                      K = Inf,
